@echo off
REM Run Dynamic Pricing Agent Demo in Docker

echo ========================================
echo   Dynamic Pricing Agent Demo
echo ========================================
echo.
...
echo.
echo Running Dynamic Pricing Agent Demo...
echo.
docker-compose -f docker-compose.simple.yml --profile demo run --rm pricing-demo
