@echo off
REM Run Marketing Email Agent Demo in Docker

echo ========================================
echo   Marketing Email Agent Demo
echo ========================================
echo.
...
echo.
echo Running Marketing Email Agent Demo...
echo.
docker-compose -f docker-compose.simple.yml --profile demo run --rm email-demo
